...
const url=`https://imdb-api.com/en/API/Title/k_yt8uwrc3/${movieId}`

const url1 = `https://imdb-api.com/en/API/Trailer/k_yt8uwrc3/${movieId}`
              ...
              <Link className='actorLink' to={`/actor/${actor.id}`}>
                <div className='castActors'>
                  <div className='castCircle'>
                    <img src={actor.image} alt={actor.name} className='cardImg' />
                  </div>
